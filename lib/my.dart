        ...
        builder: (context, snapshot) {
          ...
          return record.buyers.contains(signedUser.uid) ? Padding(
            ...
            child: GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(color: calculateDueDate(record.deadline) != '마감' ? (record.buys == record.accept ? Colors.grey : Color.fromRGBO(93, 176, 117, 1) ) : (record.buys == record.accept ? Colors.grey : Colors.redAccent),),
                  borderRadius: BorderRadius.circular(5.0),
                ),
                child: ListTile(
                  title: Container(

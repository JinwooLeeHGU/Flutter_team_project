              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    RaisedButton(
                      color: !currRecord.buyers.contains(signedUser.uid) && currRecord.address == currUser.address ? Color.fromRGBO(93, 176, 117, 1) : Colors.black12,
                      materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                      child: !currRecord.buyers.contains(signedUser.uid) ? (currUser.address == currRecord.address ? Text('참여하기', style: TextStyle(color: Colors.white, fontSize: 16),) : Text('참여불가', style: TextStyle(color: Colors.white, fontSize: 16))) : (currUser.address == currRecord.address ? Text('참여중', style: TextStyle(color: Colors.white, fontSize: 16),) : Text('참여불가', style: TextStyle(color: Colors.white, fontSize: 16),)),
                      onPressed: () {
